import type { UserData, Comment } from '../types.ts'
...
export const mockUsernames: string[] = [
  "whiskers_cat",
  "fluffy_paws_42",
  "mittens_world",
  "nyan_cat_official",
...
export const catCaptions: string[] = [
...
export const getRandomDate = (): string => {
  const timeOptions: string[] = ["1h", "2h", "3h", "5h", "8h", "12h", "1d", "2d", "3d"]
